    ...
    <form class="loginForm" method="POST" action="{{ route('login') }}">
        ...
        <div class="login_content">
            <div class="inputForm">
                ...
                <input type="email" class="normal @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required >
                @error('email')
            ...
            <div class="inputForm">
                ...
                @endif
                <input type="password" required="" class="normal @error('password') is-invalid @enderror" name="password" required>
                @error('password')
                    <div class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </div>
            ...
            <div class="login_links mt-5">
                <p class="paragraph ">Don't have an account?<a href="{{ route('register') }}">Signup</a></p>
