            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                    <div class="index__right__Sect1">
                        ...
                        <img src="assets/images/vector-1.png" class="banner__vector" alt="vector">
                    </div>
                </div>
            </div>
        </div>
...
<section class="about__section">
        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                <div class="aboutLeft__sect">
                    ...
                    <img src="assets/images/vector-2.png" alt="vector 02">
                </div>
            </div>
            <div class="col-12 col-sm-12 col-md-6 col-lg-6">
    ...
    <img src="assets/images/about_left_vector.png" class="about_left_vector" alt="">
    <img src="assets/images/about_right_vector.png" class="about_right_vector" alt="">
            ...
            <div class="row mt-5">
                <div class="col-12 col-md-4 col-lg-4">
                    <a href="featured-workout-detail.php" class="feature_item_box">
                        <img src="assets/images/feature_img1.png" alt="feature images">
                ...
                <div class="col-12 col-md-4 col-lg-4">
                    <a href="featured-workout-detail.php" class="feature_item_box">
                        <img src="assets/images/feature_img2.png" alt="feature images">
                        <div class="feature_descpt">
                ...
                <div class="col-12 col-md-4 col-lg-4">
                    <a href="featured-workout-detail.php" class="feature_item_box">
                        <img src="assets/images/feature_img3.png" alt="feature images">
                        <div class="feature_descpt">
            ...
            <div class="row">
                <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="detail_sect">
                        <img src="assets/images/heart-circle.png" alt="heart circle">
                ...
                <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="detail_sect">
                        <img src="assets/images/diamond.png" alt="Valued Teachers">
        ...
        <div class="container">
            ...
            <div class="row mt-5">
                <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                    <a href="popular-courses.php" class="cousre__video">
                        <div class="video__Box">
                            <img src="assets/images/video_1.png" alt="video_1">
                        </div>
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                    <a href="popular-courses.php" class="cousre__video">
                        <div class="video__Box">
                            <img src="assets/images/video_2.png" alt="video_2">
                        </div>
                        <div class="course_video_desc">
                            <div class="course_left_desc">
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                    <a href="popular-courses.php" class="cousre__video">
                        <div class="video__Box">
                            <img src="assets/images/video_3.png" alt="video_3">
                        </div>
                        <div class="course_video_desc">
                            <div class="course_left_desc">
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                    <a href="popular-courses.php" class="cousre__video">
                        <div class="video__Box">
                            <img src="assets/images/video_4.png" alt="video_4">
                        </div>
                        <div class="course_video_desc">
                            <div class="course_left_desc">
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                    <a href="popular-courses.php" class="cousre__video">
                        <div class="video__Box">
                            <img src="assets/images/video_5.png" alt="video_5">
                        </div>
                        <div class="course_video_desc">
                            <div class="course_left_desc">
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-4">
                    <a href="popular-courses.php" class="cousre__video">
                        <div class="video__Box">
                            <img src="assets/images/video_6.png" alt="video_6">
                        </div>
                        <div class="course_video_desc">
                            <div class="course_left_desc">
