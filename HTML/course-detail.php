            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-6">
                    <div class="course_detail_img">
                        <img src="assets/images/course_detail_img.png" alt="course-detail">
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-6">
                    <div class="course_detail_content">
                        <h3 class="traveler__fontBold">PUSHUP</h3>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <p class="paragraph">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quam ad quia maxime similique voluptates vitae aut quod dolor doloribus animi!</p>
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                        ...
                        <div class="btn__Section">
                            <a href="confirm-payment-method.php" class="cta">Enroll Now</a>
